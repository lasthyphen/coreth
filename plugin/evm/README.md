...
Atomic transactions utilize Shared Memory (documented [here](https://github.com/lasthyphen/dijetsnodesgo/blob/master/chains/atomic/README.md)) to send assets to the P-Chain and X-Chain.
