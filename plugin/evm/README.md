...
Atomic transactions utilize Shared Memory (documented [here](https://github.com/lasthyphen/dijetsnodego/blob/master/chains/atomic/README.md)) to send assets to the P-Chain and X-Chain.
