...
func (c *ChainConfig) String() string {
	...
	banner += fmt.Sprintf(" - Apricot Phase P6 Timestamp        %-8v (https://github.com/lasthyphen/dijetsnodego/releases/tag/v1.8.9)\n", c.ApricotPhasePre6BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase 6 Timestamp:        %-8v (https://github.com/lasthyphen/dijetsnodego/releases/tag/v1.8.9)\n", c.ApricotPhase6BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase Post-6 Timestamp:   %-8v (https://github.com/lasthyphen/dijetsnodego/releases/tag/v1.8.9\n", c.ApricotPhasePost6BlockTimestamp)
	banner += fmt.Sprintf(" - Banff Timestamp:                  %-8v (https://github.com/lasthyphen/dijetsnodego/releases/tag/v1.8.9)\n", c.BanffBlockTimestamp)
