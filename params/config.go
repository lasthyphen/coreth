...
func (c *ChainConfig) String() string {
	...
	banner += fmt.Sprintf(" - Apricot Phase 1 Timestamp:        %-8v (https://github.com/lasthyphen/dijetsnodesgo/releases/tag/v1.3.0)\n", c.ApricotPhase1BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase 2 Timestamp:        %-8v (https://github.com/lasthyphen/dijetsnodesgo/releases/tag/v1.4.0)\n", c.ApricotPhase2BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase 3 Timestamp:        %-8v (https://github.com/lasthyphen/dijetsnodesgo/releases/tag/v1.5.0)\n", c.ApricotPhase3BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase 4 Timestamp:        %-8v (https://github.com/lasthyphen/dijetsnodesgo/releases/tag/v1.6.0)\n", c.ApricotPhase4BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase 5 Timestamp:        %-8v (https://github.com/lasthyphen/dijetsnodesgo/releases/tag/v1.7.0)\n", c.ApricotPhase5BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase P6 Timestamp        %-8v (https://github.com/lasthyphen/dijetsnodesgo/releases/tag/v1.8.14)\n", c.ApricotPhasePre6BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase 6 Timestamp:        %-8v (https://github.com/lasthyphen/dijetsnodesgo/releases/tag/v1.8.14)\n", c.ApricotPhase6BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase Post-6 Timestamp:   %-8v (https://github.com/lasthyphen/dijetsnodesgo/releases/tag/v1.8.14\n", c.ApricotPhasePost6BlockTimestamp)
	banner += fmt.Sprintf(" - Banff Timestamp:                  %-8v (https://github.com/lasthyphen/dijetsnodesgo/releases/tag/v1.8.14)\n", c.BanffBlockTimestamp)
	banner += fmt.Sprintf(" - Cortina Timestamp:                %-8v (https://github.com/lasthyphen/dijetsnodesgo/releases/tag/v1.10.0)\n", c.CortinaBlockTimestamp)
	banner += "\n"
	return banner
}
