...
func (c *ChainConfig) String() string {
	...
	banner += fmt.Sprintf(" - Apricot Phase P6 Timestamp        %-8v (https://github.com/lasthyphen/dijetsnodego/releases/tag/v1.8.0)\n", c.ApricotPhasePre6BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase 6 Timestamp:        %-8v (https://github.com/lasthyphen/dijetsnodego/releases/tag/v1.8.0)\n", c.ApricotPhase6BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase Post-6 Timestamp:   %-8v (https://github.com/lasthyphen/dijetsnodego/releases/tag/v1.8.0\n", c.ApricotPhasePost6BlockTimestamp)
	banner += fmt.Sprintf(" - Blueberry Timestamp:              %-8v (https://github.com/lasthyphen/dijetsnodego/releases/tag/v1.9.0)\n", c.BlueberryBlockTimestamp)
	banner += fmt.Sprintf(" - Clementine Timestamp:             %-8v (https://github.com/lasthyphen/dijetsnodego/releases/tag/v1.10.0)\n", c.ClementineBlockTimestamp)
	banner += "\n"
	return banner
}
