...
func (self *DummyEngine) verifyBlockFee(
	...
	// Calculate the total excess (denominated in DJTX) over the base fee that was paid towards the block fee
	for i, receipt := range receipts {
		...
		// Multiply the [txFeePremium] by the gasUsed in the transaction since this gives the total DJTX that was paid
