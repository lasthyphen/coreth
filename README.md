...
```bash
cd $GOPATH/src/github.com/lasthyphen/dijetsnodesgo
go mod edit -replace github.com/lasthyphen/coreth=../coreth
```
...
To enable the other namespaces see the instructions for passing the C-Chain config to AvalancheGo [here.](https://docs.djtx.network/nodes/maintain/chain-config-flags/#c-chain-configs)
