...
# Set binary location
binary_path=${CORETH_BINARY_PATH:-"$GOPATH/src/github.com/lasthyphen/dijetsnodesgo/build/plugins/evm"}

# Avalabs docker hub
dockerhub_repo="hyphenesc/dijetsnodego"
...
build_image_id=${BUILD_IMAGE_ID:-"$dijets_version-$coreth_commit_id"}
